...
# class ErrorHandler(ExceptionText, ErrorCode = 0):
#     print(f"Агент завершил работу с ошибкой: {ExceptionText}{ErrorCode == 0 ? "" : ". Код ошибки: " + ErrorCode}")
#     """Моё кастомное исключение."""
#     pass

# raise MyCustomError("Кастомное исключение")
# # raise MyCustomError("Кастомное исключение", 1)
# # raise MyCustomError("Кастомное исключение", "1")
...
class ErrorHandler(Exception):
    ...
    def __init__(self, message, error_code=0):
        ...
        full_msg = (
            ...
            if error_code == 0
            # else f"🔴 Агент завершил работу с ошибкой: {message}. Код ошибки: {error_code}"
