...
Затем проверка комбинации, что бы всё работало

И эту сливку можно будет ставлять в шаблон, и практически parseCard мы написали

Также возможно поудмать насчёт того, что бы находить фрагменты json кода, но это позже
"""
