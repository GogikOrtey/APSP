...
Нужно прописать удаление страниц, старше месяца
И использование страниц из кеша, которые не старше 18 часов
...
Нужно поправить формирование селекторов (а точнее дистилляцию) - 
    что бы он в результате давал селектор, который указывает
    на один верный элемент, а не на первый верный
